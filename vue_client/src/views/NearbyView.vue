				...
				<div class="place-item__main">
					...
					<div class="place-item__badge">
						<span class="walk-pill">
							<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><path d="M13 4a1 1 0 1 1-2 0 1 1 0 0 1 2 0zM8 17l1-4 2 2 2-4M6 11l1-3a5 5 0 0 1 4-2h2l2 3h3M6 21l2-4"/></svg>
...
.state-icon-wrap--err { color: var(--c-err-500); }
...
.place-name { font-size: var(--fs-lg); font-weight: 700; color: var(--c-text); display: block; margin-bottom: 6px; }
.place-meta {
	display: flex;
	align-items: center;
	gap: var(--sp-2);
...
.action-link--tel:hover { background: var(--c-bg-soft); color: var(--c-text); }
.action-link--map {
	background: var(--c-brand-500);
	color: #fff;
	border: 1px solid var(--c-brand-500);
}
.action-link--map:hover { background: var(--c-brand-600); }
