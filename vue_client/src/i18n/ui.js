...
const messages = {
  ...
  'role.normalUser':        { ko: '일반 사용자',     en: 'User',            ja: '一般ユーザー',         zh: '普通用户' },
  'role.pos':               { ko: 'POS',             en: 'POS',             ja: 'POS',                 zh: 'POS' },
  'role.hkMgr':             { ko: '객실정비 관리자', en: 'Housekeeping Mgr', ja: '客室整備管理者',      zh: '客房管理' },
  'role.hkUser':            { ko: '객실정비 사용자', en: 'Housekeeping',    ja: '客室整備',            zh: '客房员' },
  ...
  'admin.ccs.col.deptCd':        { ko: '부서 코드',          en: 'Dept Code',                    ja: '部署コード',             zh: '部门代码' },
  'admin.ccs.col.deptNm':        { ko: '부서명',             en: 'Department',                   ja: '部署名',                 zh: '部门名' },
  'admin.ccs.col.sortOrd':       { ko: '정렬',               en: 'Sort',                         ja: '並び順',                 zh: '排序' },
  'admin.ccs.col.useYn':         { ko: '사용여부',           en: 'Active',                       ja: '使用',                   zh: '是否使用' },
  'admin.ccs.col.loginId':       { ko: '로그인 ID',          en: 'Login ID',                     ja: 'ログインID',             zh: '登录账号' },
  'admin.ccs.col.staffNm':       { ko: '이름',               en: 'Name',                         ja: '名前',                   zh: '姓名' },
  'admin.ccs.col.userTp':        { ko: '역할',               en: 'Role',                         ja: '役割',                   zh: '角色' },
